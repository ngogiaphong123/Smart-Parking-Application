...
function AiFloatingChatRoom({ positionSide }: { positionSide: string }) {
    ...
    return (<>
        <motion.form
            ...
            }} className={clsx("rounded-xl shadow-lg absolute w-64 sm:w-96 h-fit max-w-96 flex flex-col items-center", {
                "bottom-0 left-[50px]": positionSide === "left",
                "bottom-0 right-[70px]": positionSide === "right"
            })}>
            <div className="w-full h-96 bg-gray opacity-50 fixed bottom-0 left-0 z-0">
            </div>
            <div ref={chatRoomRef} className="w-full h-96 max-h-96 bg-transparent z-10 overflow-y-auto flex flex-col justify-end">
