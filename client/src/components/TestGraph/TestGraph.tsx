...
const TestGraph = () => {
    ...
    //     // @ts-ignore
    //     setClickedLocation({ latitude: clickedLatitude, longitude: clickedLongitude });
    //   };
    ...
    const marker = {
        latitude: 10.744418,
        longitude: 106.658213
    };
    const myschool = {
        latitude: 10.7512228,
        longitude: 106.655394
    }
    ...
    // move the marker long the route lineStringCoordinates every 200ms
    // useEffect(()=>{
    //     // move the marker long the route lineStringCoordinates every 200ms
