...
function HeaderUser({ role, isMenuOpen }: { role:string, isMenuOpen: boolean }) {
    ...
    return (<>
        <div className="w-60 items-center justify-between flex ">
            ...
            <div  className="relative hover:bg-gray-hover cursor-pointer flex w-44 rounded-xl items-center justify-center border-solid border-1 border-gray-200 overflow-hidden">
                ...
                <div className="flex w-full items-center justify-center px-4">
                    ...
                    {
                        !isMenuOpen &&
                        <div ref={myRef} onClick={handleAvatarClickInside} className={"pl-4"}>
