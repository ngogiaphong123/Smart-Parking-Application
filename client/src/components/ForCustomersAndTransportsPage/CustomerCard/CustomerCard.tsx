...
function CustomerCard() {
    return (<>
        ...
        <div className="w-full cursor-pointer bg-white hover:bg-gray ease-in-out rounded-xl p-4  flex items-center drop-shadow-md">
            ...
            <div className="flex flex-col justify-center items-start flex-[2_2_0]">
                ...
                <p className="font-thin text-super-small capitalize">2 transportations</p>
