...
import { customerGetLogs, getLogs, getLogsDate } from '../../redux/slices/LogsSlice'

const useGetLogs = ({paidState, currPage, date, setTotalPage}:{paidState:string, currPage:number, date?:any, setTotalPage:any}) => {
